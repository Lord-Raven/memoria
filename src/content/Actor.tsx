...
function buildEmotionPromptGenerationInstruction(actor: Actor, outfit: Outfit, emotion: Emotion): string {
    ...
    return `{{messages}}This is a preparatory request for a single image-edit instruction for character art generation.\n\n` +
        ...
        `The prompt is intended to guide the model in adjusting the image to suit the target mood by visually describing this character's expression, posture, gesture, ` +
        `and demeanor in a way that takes their style, personality, and outfit into account where appropriate. ` +
        `The image is a standing portrait and does not involve the character's surroundings. ` +
        ...
        `Example response:\n` +
        `This character is now in a somber, reflective mood. He looks downcast, with slumped shoulders and a frown. His eyes look down and away, and he appears lost in thought.\n#END#\n`;
}
